...
target("init")
    ...
    on_run(function (target)
        ...
        os.cd("rocket-chip")
        os.exec("git submodule update --init dependencies/cde")
        os.exec("git submodule update --init dependencies/diplomacy")
        os.exec("git submodule update --init dependencies/hardfloat")
    end)
