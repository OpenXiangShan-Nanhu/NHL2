...
class MissHandler()(implicit p: Parameters) extends L2Module {
    ...
    mshrs.zip(UIntToOH(io.mshrAlloc_s3.bits.mshrId).asBools).zipWithIndex.foreach { case ((mshr, en), i) =>
        ...
        mshr.io.retryTasks.stage2.bits.refill_s2   := retry_s2.bits.refill_s2
        ...
        mshr.io.retryTasks.stage2.bits.ncbwrdata_opt_s2.foreach(_ := retry_s2.bits.ncbwrdata_opt_s2.getOrElse(false.B))
        ...
        mshr.io.retryTasks.stage4.bits.refill_s4   := retry_s4.bits.refill_s4
